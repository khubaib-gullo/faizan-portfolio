	...
	return (
		<Box minH="100vh" pt={{ base: 20, md: 24 }}>
			...
			<Container maxW="7xl" py={{ base: 12, md: 20 }}>
				<Flex
					direction="column" // Force column direction for all screen sizes
					align="center" // Center the content horizontally
					justify="center" // Center vertically if space allows
					gap={12}
				>
					<MotionVStack
						align="center" // Center all text content
						spacing={6}
						flex={1}
						textAlign="center" // Center the text within the VSTack
						initial={{ opacity: 0, y: 50 }} // Adjusted animation for centered layout
